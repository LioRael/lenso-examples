...
fn main() {
    ...
    .unwrap_or_else(|error| {
        panic!(
            "Story Events generated artifacts are stale: {error}. Run `cargo run -p lenso-contract-codegen -- generate capability.json src/generated.rs generated/bindings.ts`"
        )
    });
}
